...
var config = {
  apiOrigins: {
    ...
    production: 'https://contractortracker.herokuapp.com/'
  }
};
...
var contractorsEvents = __webpack_require__(17);
...
var onCreate = function onCreate(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createContractor(data).then(ui.onCreateSuccess).catch(ui.onCreateFailure);
};

// ON SHOW-ALL
var onShowAll = function onShowAll(event) {
  event.preventDefault();
  api.showAllContractors().then($('#result-container').empty()).then(ui.onShowAllSuccess).catch(ui.onShowAllFailure);
};

//
// GET CONTRACTOR
var getContractor = function getContractor(event) {
  var data = getFormFields(event.target);
  event.preventDefault();
  // console.log(data)
  api.getContractor(data.id).then($('#result-container').empty()).then(ui.getContractorSuccess).catch(ui.getContractorFailure);
};
...
//
// ON DELETE
var deleteContractor = function deleteContractor(event) {
  event.preventDefault();
...
var createContractor = function createContractor(data) {
  return $.ajax({
...
var showAllContractors = function showAllContractors() {
  return $.ajax({
    url: config.apiOrigin + '/contractors',
    method: 'GET',
    headers: {
...
var getContractor = function getContractor(id) {
  return $.ajax({
...
var updateContractor = function updateContractor(data) {
  // console.log(data)
...
var deleteContractor = function deleteContractor(id) {
  // console.log(id)
  return $.ajax({
    url: config.apiOrigin + '/contractors/' + id,
    method: 'DELETE',
...
var onCreateSuccess = function onCreateSuccess(data) {
  var listHTML = showlistTemplate({ list: data.contractor });
...
var onShowAllSuccess = function onShowAllSuccess(data) {
  // console.log(data)
  var listHTML = showlistsTemplate({ lists: data.contractors });
  $('#result-container').append(listHTML);
...
// SHOW CONTRACTOR
var getContractorSuccess = function getContractorSuccess(data) {
  // console.log(data)
  var listHTML = showlistTemplate({ list: data.contractor });
  $('#result-container').append(listHTML);
  // $('#result-display').fadeIn(1000).delay(1000).fadeOut(300)
...
var getContractorFailure = function getContractorFailure() {
...
module.exports = {
  ...
  getContractorSuccess: getContractorSuccess,
  getContractorFailure: getContractorFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <tr>\n        <td>"
    ...
    + "</td>\n        <td>\n      <!-- <button class=\"edit-book btn btn-warning\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Edit</button> -->\n      <button class=\"delete-book btn btn-danger\" id=\"list-delete\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</button>\n\n     </td>\n      </tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<h2>CONTRACTOR LIST</h2>\n\n<input type=\"text\" id=\"myInput\" onkeyup=\"myFunction()\" placeholder=\"Search By First Name\" title=\"Search for a name\">\n<input type=\"text\" id=\"lastNameInput\" onkeyup=\"Create()\" placeholder=\"Search By Last Name\" title=\"Search for a name\">\n<input type=\"text\" id=\"birthInput\" onkeyup=\"DOB()\" placeholder=\"Search By DOB\" title=\"Search for a name\">\n<div class=\"row\">\n  <table class=\"table table-bordered table-striped\" id=\"myTableHeader\" data-id=\""
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.contractor : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n    <thead>\n      <tr>\n        <th>Contractor ID#</th>\n        <th>First Name</th>\n        <th>Last Name</th>\n        <th>Date of Birth</th>\n        <th>Gender</th>\n      </tr>\n    </thead>\n    <tbody id=\"myTable\">\n"
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return " -->\n      <!-- <tr>\n        <td>"
    ...
    + "</td>\n        <td>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.first_name : stack1), depth0))
    + "</td>\n        <td>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.last_name : stack1), depth0))
    + "</td>\n        <td>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.born_on : stack1), depth0))
    + "</td>\n        <td>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.gender : stack1), depth0))
    + "</td>\n        <td> -->\n          <!-- <button class=\"edit-book btn btn-warning\" data-book-id=\""
    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data}) : helper)))
    + "\">Edit</button> -->\n\n        <!-- </td>\n      </tr> -->\n      <!-- ";
  ...
  return "<ul>\n\n  <div class=\"body\">\n    <ul class=\"unstyled\">\n      <li class=\"list-group-item\" data-id=\""
    ...
    + "\">Contractor ID: #"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + " </li>\n      <li class=\"list-group-item\"> First_Name : "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.first_name : stack1), depth0))
    + " </li>\n      <li class=\"list-group-item\"> Last_Name: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.last_name : stack1), depth0))
    + " </li>\n      <li class=\"list-group-item\"> Born On: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.born_on : stack1), depth0))
    + " </li>\n      <li class=\"list-group-item\"> Gender: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.gender : stack1), depth0))
    + " </li>\n      <!-- <li class=\"list-group-date\"> Hire Date: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.hire_date : stack1), depth0))
    + " </li> -->\n\n</div>\n\n</ul>\n      <!-- <button class=\"delete-book btn btn-danger\" id=\"partial-delete\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.contractor : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">Delete</button> -->\n</div>\n</ul>\n\n<!-- <div class=\"row\">\n  <table class=\"table table-bordered table-striped\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.list : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n    <thead>\n      <tr>\n        <th>Contractor ID#</th>\n        <th>First Name</th>\n        <th>Last Name</th>\n        <th>Date of Birth</th>\n        <th>Gender</th>\n      </tr>\n    </thead>\n    <tbody>\n      <!"
    + ((stack1 = helpers.each.call(alias3,(depth0 != null ? depth0.lists : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + " -->\n    <!-- </tbody>\n  </table> -->\n\n\n<!-- <h1>Table</h1>\n<table class=\"table\">\n  <thead>\n    <tr>\n      <th>Contractor ID: #</th>\n      <th>First Name</th>\n      <th>Last Name</th>\n      <th>Born On</th>\n    </tr>\n  </thead>\n  <tbody>\n"
    + ((stack1 = helpers.each.call(alias3,(depth0 != null ? depth0.contractors : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </tbody>\n</table> -->\n";
},"useData":true,"useBlockParams":true});
